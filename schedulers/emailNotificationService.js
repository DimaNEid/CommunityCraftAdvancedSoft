...
const transporter = nodemailer.createTransport({
    ...
    auth: {
      user: config.NotificationProviderConfig.email,
      pass: config.NotificationProviderConfig.password
    },
    tls: {
...
const sendEmail = (to, subject, text) => {
  const mailOptions = {
    from: config.NotificationProviderConfig.email, // Replace with your email
    to: to,
    subject: subject,
    text: text
  };
